			...
			<div class="contact-bottom">
				 <div class="contact-text">
					<div class="col-md-9 contact-left">
						<form action="breed_resp.php" method="post">
							<h3>选择宠物</h3>
';					

$sql = "SELECT USER_ID, PET_ID, PET_PIC, PET_NAME FROM PET LEFT OUTER JOIN USER USING(USER_ID)
		WHERE PET.USER_ID=USER.USER_ID AND USER.MAIL= '".$_SESSION['user_mail']."' ORDER BY PET_ID";
$result =db_query($sql);
...
if (db_num_rows($result) > 0) {
	...
	echo '
		...
		<input type="hidden" name="pz" value="'.$_POST["pz"].'">
	';
} 
?>
							<h3>所在地</h3>
