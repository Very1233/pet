			...
			<div class="contact-bottom">
				 <div class="contact-text">
					<div class="col-md-9 contact-left">
						<form action="pet_change.php" method="post">
                        ...
                        <input type="text" value="宠物性别" name="pet_sex"onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '宠物性别';}" style="border:solid #b28b51;"/><br>
                        <br>
                         <p>宠物生日</p>
                        ...
                        <!--传递宠物ID--> 
                      <?php
        echo '<input type="hidden" name="changepet_htm_id" value="'.$_POST["changepet_id"].'" >';
		?>
