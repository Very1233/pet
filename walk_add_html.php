			...
			<div class="contact-bottom">
				 <div class="contact-text">
					<div class="col-md-9 contact-left">
						<form action="walk_add.php" method="post">
							<h3>遛宠时间</h3>
							<input type="date" name="sdate" style="border:solid #b28b51;"> <input type="time" name="stime" style="border:solid #b28b51;"> 到  <input type="date" name="edate" style="border:solid #b28b51;"> <input type="time" name="etime" style="border:solid #b28b51;"></br></br> 
...
Gid('s_county').setAttribute('onchange','showArea()');
							...
							<h3>遛宠数目</h3>
							<input type="number" name="num" style="border:solid #b28b51;"></br></br>
 							<h3>遛宠描述</h3>
